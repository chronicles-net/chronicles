    ...
    where T : class
{
    ...
    /// <summary>
    /// Attempts to read the specified <typeparamref name="TResult"/> document,
    /// and returns <c>null</c> if none was found.
    /// </summary>
    /// <typeparam name="TResult">The type used for the custom document result.</typeparam>
    /// <param name="documentId">Id of the document.</param>
    /// <param name="partitionKey">Partition key of the document.</param>
    /// <param name="options">(Optional) Query request options to use.</param>
    /// <param name="cancellationToken">(Optional) <seealso cref="CancellationToken"/> representing request cancellation.</param>
    /// <returns>A <see cref="Task"/> containing the requested <typeparamref name="TResult"/> document, or null.</returns>
    ...
    /// <summary>
    /// Reads the specified <typeparamref name="TResult"/> document from the configured
    /// Cosmos collection.
    /// </summary>
    /// <remarks>
    /// A <see cref="CosmosException"/>
    ...
    /// <param name="options">(Optional) Query request options to use.</param>
    /// <param name="cancellationToken">(Optional) <seealso cref="CancellationToken"/> representing request cancellation.</param>
    /// <returns>A <see cref="Task"/> the requested <typeparamref name="TResult"/> document.</returns>
    ...
    public IAsyncEnumerable<TResult> QueryAsync<TResult>(
        ...
        string partitionKey,
        CancellationToken cancellationToken = default)
        => QueryAsync(query, null, partitionKey, cancellationToken);
    ...
    public Task<PagedResult<T>> PagedQueryAsync(
        ...
        CancellationToken cancellationToken = default)
        => PagedQueryAsync<T>(query, partitionKey, pageSize, continuationToken, cancellationToken);
    ...
    public Task<PagedResult<TResult>> PagedQueryAsync<TResult>(
        ...
        string? continuationToken = default,
        CancellationToken cancellationToken = default)
        => PagedQueryAsync<TResult>(query, null, partitionKey, pageSize, continuationToken, cancellationToken);
    ...
    public Task<PagedResult<TResult>> PagedQueryAsync<TResult>(
        ...
        string? continuationToken = default,
        CancellationToken cancellationToken = default)
        => PagedQueryAsync(query, null, partitionKey, pageSize, continuationToken, cancellationToken);
