### 2026-03-05T06:46:09Z: User directive
**By:** Lars Skovslund (via Copilot)
**What:** The architectural layering must always be enforced:
...
**Why:** User request — captured for team memory and enforcement in all code review and development decisions
