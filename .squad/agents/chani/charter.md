...
## Responsibilities
- Write and maintain tests in `test/Chronicles.Tests/`
- Use xunit.v3 consistent with existing test conventions
...
- Review `docs/testing.md` examples for accuracy and completeness
