...
|-----------|----------|----------|
| Architecture & decisions | Thufir | API design, scope calls, review gates, breaking changes |
| Backend / framework code | Gurney | C# implementation, Cosmos DB, DI wiring, EventStore/Documents/Cqrs |
| Event sourcing & CQRS design | Duncan | Stream modeling, aggregate design, projection strategy, event schemas |
| Testing | Chani | xunit tests, integration coverage, edge cases, coverage reports |
| DevOps & infrastructure | Stilgar | GitHub Actions, Aspire, build config, NuGet packaging, CI fixes |
| Code review | Thufir | Review PRs, check quality, suggest improvements |
| Scope & priorities | Thufir | What to build next, trade-offs, decisions |
