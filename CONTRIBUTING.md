...
Start a discussion on the [chronicles discussion list](https://github.com/chronicles-net/chronicles/discussions).

## Bugs and feature requests
For bugs or feature requests, log a new issue on the [issues list](https://github.com/chronicles-net/chronicles/issues). Be sure to use the right template.

## Contributing Code and Content

`Chronicles` accepts fixes and features. Here is what you should do when writing code for `chronicles`:
...
* ["Help wanted" issues](https://github.com/chronicles-net/chronicles/labels/help%20wanted) - these issues are up for grabs if you want to create a fix. To do this, simply comment on the issue you want to fix.
* ["Good first issue" issues](https://github.com/chronicles-net/chronicles/labels/good%20first%20issue) - these are good for newcomers. Good first issues are small, usually require just a few hours of work, and do not require a deep technical knowledge of `chronicles`. This is a good place to start if you want to become familiar with `chronicles` inner workings and maybe take on bigger issues later.

### Identifying the Scale of a Contribution

If you would like to contribute to `chronicles`, first identify the scale of what you would like to contribute. If it is small (grammar/spelling or a bug fix), feel free to start working on a fix. If you are submitting a feature or substantial code contribution, please discuss it with us first. 
